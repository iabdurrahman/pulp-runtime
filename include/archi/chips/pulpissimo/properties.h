...
// #define ARCHI_UDMA_SPIM_ID(id)            2
#define ARCHI_UDMA_SPIM_ID(id)            ((ARCHI_UDMA_UART_ID(   ARCHI_UDMA_NB_UART   )) + (id))
// #define ARCHI_UDMA_I2C_ID(id)             4
#define ARCHI_UDMA_I2C_ID(id)             ((ARCHI_UDMA_SPIM_ID(   ARCHI_UDMA_NB_SPIM   )) + (id))
// #define ARCHI_UDMA_SDIO_ID(id)            4
// #define ARCHI_UDMA_I2S_ID(id)             4
// #define ARCHI_UDMA_CAM_ID(id)             4
// #define ARCHI_UDMA_FILTER_ID(id)          4
// #define ARCHI_UDMA_TRACER_ID(id)          4
// #define ARCHI_UDMA_TGEN_ID(id)            4
